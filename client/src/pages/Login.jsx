  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <div className='flex flex-col items-center'>
        <img src={assets.logo} className='w-32 h-32 ml-6 mb-2'/>
        <p className='text-white text-5xl mt-2'>ChatBox</p>
      </div>
      {/* Right side */}
      ...
      <form className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg' onSubmit={onSubmitHandler}>
        ...
        {
          currState === "Sign up" && isDataSubmitted && (
            <textarea rows={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='Provide a short bio...' onChange={(e)=>setBio(e.target.value)} value={bio}>
